...
from crawl4ai.crawlers.async_crawlers.async_webcrawler import AsyncWebCrawler, CacheMode
...
from crawl4ai.strategies.chunking.chunking_strategy import (
    ChunkingStrategy as BaseChunkingStrategy,
    RegexChunking,
    NlpSentenceChunking
)
from crawl4ai.strategies.content_filtering.content_filter_strategy import (
    PruningContentFilter, 
    BM25ContentFilter,
    RelevantContentFilter
)
from crawl4ai.models.models import CrawlResult
...
class CrawlRequest(BaseModel):
    ...
    chunking_strategy: Optional[ChunkingConfig] = None
